...
public class resturant extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        orders.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "الرقم التعريفي", "الاجمالي", "التاريخ"
            }
        ) {
    ...
    private void confirmActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_confirmActionPerformed
        ...
        boolean areValid = this.validateData();
        if (areValid) {
            int res = JOptionPane.showConfirmDialog(this, "تاكيد الطلب ؟ ");
            if (res == 0) {
                if (this.c != null) {
                    // Get total
                    int total = 0;
                    ...
                    try {
                        ...
                        stmt.executeUpdate();
                        this.showOrders();
                        JOptionPane.showMessageDialog(this, "تمت اضافه الطلب بنجاح");
                        this.resetInputs();
    ...
    private boolean validateData() {
        ...
        if (validInpts == 0) {
            JOptionPane.showMessageDialog(this, "لا بد ان يكون منتج واحد علي الاقل اكبر من صفر");
            return false;
        }
        return true;
    }
